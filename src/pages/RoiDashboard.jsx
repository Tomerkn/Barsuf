  ...
  return (
    <div className="p-10 max-w-[1400px] mx-auto text-right bg-[#FAFAFA] min-h-full" dir="rtl">
      ...
      <div className="mb-14 border-b border-slate-200 pb-10">
        <h1 className="text-5xl font-light text-[var(--color-brand)] tracking-tight mb-4">החזר השקעה (ROI)</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-px bg-slate-200 border border-slate-200 rounded-3xl overflow-hidden mb-16 shadow-sm">
        ...
        <div className="bg-white p-8">
          ...
          <div className="text-4xl font-light text-[var(--color-brand)] mb-4">4 <span className="text-2xl text-slate-400">ימים</span></div>
        ...
        <div className="bg-white p-8">
          ...
          <div className="text-4xl font-light text-[var(--color-brand)] mb-4">4 <span className="text-2xl text-slate-400">הצעות</span></div>
          <div className="flex items-center gap-1.5 text-sm text-emerald-600 font-medium">
        ...
        <div className="bg-white p-8">
          ...
          <div className="text-4xl font-light text-[var(--color-brand)] mb-4">0%</div>
        ...
        <div className="bg-white p-8 relative overflow-hidden group">
          <div className="absolute top-0 left-0 w-1 h-full bg-[var(--color-brand)]"></div>
          <div className="text-sm font-medium text-slate-500 mb-4">חיסכון מצטבר מוערך בשנה</div>
          <div className="text-4xl font-bold text-[var(--color-brand)] mb-4 tracking-tight">₪91K</div>
          ...
          <div className="h-80 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={financialData} margin={{ top: 10, right: 0, left: 0, bottom: 0 }}>
                ...
                <Area type="monotone" dataKey="חיסכון מצטבר" stroke="var(--color-brand)" strokeWidth={3} fillOpacity={1} fill="url(#colorSavings)" />
          ...
          <div className="h-80 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={timeData} margin={{ top: 10, right: 0, left: 0, bottom: 0 }} barSize={32}>
                ...
                <Bar dataKey="אוטומטי" name="אחרי המערכת (שעות)" fill="var(--color-brand)" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
