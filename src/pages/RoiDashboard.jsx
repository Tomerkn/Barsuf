        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
            ...
            <div className="prose prose-slate prose-p:leading-relaxed text-slate-600 text-sm">
              <p>
                הטמעת monday.com בחברת ברסוף בע"מ יצרה שינוי מהותי בתהליך הגשת הצעות המחיר - מתהליך ידני, מפוזר ולא שיטתי לתהליך דיגיטלי, מובנה ואוטומטי. הערך שנוצר אינו רק טכני אלא עסקי: <strong>החברה מסוגלת כיום לנהל יותר הצעות במקביל, לצמצם טעויות ולהתבסס על תשתית ניהולית שתאפשר צמיחה ללא הגדלת עלויות.</strong>
              </p>
              <p className="mt-4">
                עבור יאיר, השינוי בחוויית העבודה הוא המשמעותי ביותר ברמה היומיומית - פחות בלגן, יותר שליטה, ופנאי להתמקד במה שהוא טוב בו: ניהול ביצוע פרויקטים בשטח.
              </p>
            </div>
          </div>
          ...
          {[
            {
              ...
              title: "1. יעילות תפעולית",
              desc: "חיסכון של כ-6 שעות לכל הצעת מחיר מאפשר ליאיר לנהל יותר פרויקטים ללא גיוס כוח אדם נוסף. בהנחה שהחברה מגישה כ-15-20 הצעות בשנה, מדובר בחיסכון מצטבר של 90-120 שעות עבודה."
            },
            {
              icon: TrendingUp, color: 'text-blue-500', bg: 'bg-blue-100',
              title: "2. הגדלת יכולת הגשה",
              desc: "לפני הטמעת המערכת, העומס הידני הגביל את היכולת לנהל מעל שתי הצעות בו-זמנית. עם המערכת ניתן לנהל ארבע הצעות במקביל - מה שמאפשר לחברה לגדול מבלי להגדיל הוצאות."
            },
            {
            ...
            },
            {
              ...
              title: "4. ניהול ידע ארגוני",
              desc: "תיעוד שיטתי של כל הצעה - כולל תשובת הלקוח וסיבת הפסד במכרז - מייצר לחברה מאגר נתונים מנוהל. מנהל החברה יכול לנתח אילו פרויקטים מניבים יותר."
            },
            {
              icon: HeartHandshake, color: 'text-rose-500', bg: 'bg-rose-100',
              title: "5. שיפור חוויית עבודה",
              desc: "יאיר עובר מסביבת עבודה מתסכלת (חיפוש קבצים ומרדף אחר קבלנים) לסביבה ממוקדת בה הוא מוביל תהליכים. שיפור בהפחתת עומס קוגניטיבי."
            }
          ].map((item, idx) => (
